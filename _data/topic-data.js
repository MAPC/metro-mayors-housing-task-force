...
const strategies = [
  {
    ...
    practices: [
      {
        considerations:
          "Depending on their capacity, municipalities should consider working with a technical assistance provider or other project partner to develop an HPP. Communities should also provide opportunities for community engagement, have a clear action plan for implementing the strategies outlined in the HPP, and build coalitions to advance implementation of the HPP.",
        ...
        overview:
          "A five-year plan to meet existing and projected housing need and demand and to respond to MGL Chapter 40B development. The three-part plan analyzes housing need and demand in a community, considers housing development capacity and opportunities, and establishes housing goals and strategies.",
        who: "Local government",
        principles: [engagement, production, preservation, affordability, diversity, location],
      ...
      },
      {
        ...
        principles: [engagement, fair, stability, affordability, preservation],
      ...
      {
        considerations:
          "Many of these ordinances have been adopted in hot-market cities with rent-regulated units where landlords may have strong financial incentive to encourage tenants to relocate. ",
      ...
      },
      {
        ...
        resources: {
          ...
          links:
            "https://www.oaklandca.gov/services/eviction/read-the-just-cause-for-eviction-ordinance\n\nhttp://www.policylink.org/sites/default/files/just-cause-eviction-controls.pdf",
        },
      },
      {
        considerations: "",
      ...
      {
        additional: true,
        principles: [engagement, production, location, complete],
      ...
      {
        additional: true,
        principles: [engagement, production, preservation, affordability, diversity, location, complete, design, stability, fair],
      ...
      {
        additional: true,
        principles: [engagement, production, affordability, location],
        overview:
          "Authorizes a state grant or loan to a local government for planning and environmental reviews of a particular neighborhood. Developers working in the designated area provide a certain percentage of affordable units in exchange for expedited review. ",
        location: "California",
        resources: {
          titles: "SB 540 Text\n\nCalifornia Budget & Policy Center: 2017 Housing Legislative Package",
          links:
            "https://leginfo.legislature.ca.gov/faces/billTextClient.xhtml?bill_id=201720180SB540\n\nhttp://calbudgetcenter.org/blog/understanding-recently-enacted-2017-state-legislative-housing-package/",
        },
  ...
  },
  {
    ...
    practices: [
      {
        considerations:
          "Any effort to expedite the permitting process first begin with a detailed analysis of a municipality's existing permitting and review process. This analysis should be ongoing in order to evaluate the performance of, and make adjustments to, any amendments and/or new strategies.",
      ...
      {
        considerations:
          'Reducing or eliminating parking minimums alone may not  work to discourage developers from providing excess parking or encourage new residents to opt for alternative modes of transportation. Reductions in parking requirements can be paired with "residential transportation options programs," which require or incentivize developers to provide transit passes, car share memberships, and other mobility options for residents of new buildings. ',
        ...
        who: "Local government",
        principles: [production, affordability, location],
        adoption: "Local Action",
        location: "Arlington, MA\nCoral Gables, FL\nFort Myers, FL\nMalden, MA\nMelrose, MA\nMilwaukee, WI\nSeattle, WA\nSpokane, WA",
        where:
          "Needham, MA - The Town of Needham allows developers that construct buildings within certain districts to pay a one-time fee to the Needham Center Off-Street Parking Fund in exchange for constructing fewer spaces than are otherwise required. The fee per space increases proportionally with the number of spaces not constructed.\n\nArlington, MA, and Melrose, MA - In April 2016, the Town of Arlington voted to reduce minimum parking requirements in some downtown districts. Around the same time, the City of Melrose approved a similar zoning amendment in their downtown and around three commuter rail station areas.",
        resources: {
      ...
      },
      {
        ...
        who: "Local government",
        principles: [engagement, production, affordability, diversity, design],
        adoption: "Local Action",
        location: "California\nCanada\nOregon\nWashington ",
        where:
      ...
      },
      {
        ...
        overview:
          "Municipalities must waive special permit requirements for affordable housing developments if housing production has not kept pace with state home-building targets.",
      ...
      },
      {
        ...
        overview:
          "Efficient and clear development permitting processes based on analysis of the existing framework and identification of areas for improvement",
        ...
        principles: [engagement, production],
        adoption: "Legislation",
        location: "California",
        ...
        resources: {
          ...
          links:
            "http://alcl.assembly.ca.gov/sites/alcl.assembly.ca.gov/files/AB%20879%20analysis.pdf\n\nhttps://leginfo.legislature.ca.gov/faces/billTextClient.xhtml?bill_id=201720180AB879",
        },
      },
      {
        considerations:
          'Technically, bill H.4075 can still pass this year in what is called \u201cinformal session" if it has unanimous support from both the House and Senate. If the bill fails to pass before the end of informal session, the Governor will have to reintroduce it at the start of the next legislative session in 2019. ',
        ...
        overview:
          "Removes barriers to new Allows cities and towns to adopt certain zoning changes by a simple majority vote, rather than two-thirds super majority.",
      ...
      {
        considerations:
          "Zoning reform advocates would have to reintroduce new bills in the next legislative session in order for comprehensive zoning reform or any of the individual provisions of the Great Neighborhoods legislation to be realized at a statewide scale. There are several provisions that municipalities can adopt on their own without legislation, such as expanding zoning for multifamily housing and accessory dwelling units. Advocates for zoning reform can encourage their local municipalities and legislators to support these changes. ",
        ...
        principles: [engagement, production, diversity, location, affordability],
        adoption: "Legislation",
        location: "Massachusetts",
        where:
          "Massachusetts - In the 2017-18 legislative session, an attempt to pass certain provisions of the Great Neighborhoods legislation, including those pertaining to multifamily housing and accessory dwelling units, as amendments to the Housing Choice bill was unsuccessful. Despite being endorsed by over 100 organizations and local leaders, demonstrating broad support from advocacy organizations, business groups and municipal officials, the Great Neighborhoods legislation failed to secure sufficient support in the House of Representatives. ",
        resources: {
      ...
      {
        considerations:
          "Right size parking is a planning tool. Findings from this type of data collection and analysis can inform parking recommendations in local plans, updates to zoning code for a particular district or across a municipality, or specific changes during the site plan review processes.    ",
      ...
      {
        additional: true,
        principles: [engagement, production, affordability, diversity],
        overview:
          "Municipal or state regulation waiving or reducing certain requirements and fees that disproportionately impact ADU construction, such as water and sewer connection fees or parking requirements.",
      ...
      },
      {
        ...
        principles: [engagement, production, location, complete],
        overview:
          'TDR allows density rights from at-risk affordable housing units to be "bought" by developers as density credits; some cities and towns establish TDR banks to purchase development rights and sell them at a later date when there is more demand for development rights.',
      ...
      {
        additional: true,
        principles: [engagement, production, diversity],
        overview:
          "Municipal zoning that allows individual lot sizes within a development to vary from maximum allowable density, provided that the average size in the development as a whole meets the requirements. ",
      ...
      {
        additional: true,
        principles: [engagement, production, diversity, location],
      ...
      {
        additional: true,
        principles: [engagement, production, diversity, location, complete],
        overview:
          "Municipal zoning that allows different uses to co-locate within a zone as long as the development achieves specified performance criteria based on planning goals.",
        location: "Bedford, NH",
        resources: {
      ...
      {
        additional: true,
        principles: [production, diversity, location],
        overview:
          "Municipal zoning that encourages development in existing built-out areas, taking advantage of existing infrastructure and preserving undeveloped greenfields. ",
        location: "Nationwide",
        resources: {
          titles: "Greenbelt Alliance: Smart Infill Guide",
          links: "https://www.greenbelt.org/research/smart-infill/",
      ...
      {
        additional: true,
        principles: [production, diversity, location, complete],
      ...
      {
        additional: true,
        principles: [production, affordability, diversity, location],
      ...
      {
        additional: true,
        principles: [production, affordability, diversity, location, stability, fair],
        overview:
          "Municipal zoning that allows mobile and manufactured homes to be located in single-family zones to increase affordability and housing choice. ",
        location: "Nationwide",
        resources: {
      ...
      {
        additional: true,
        principles: [production, affordability, diversity, design, stability, fair],
      ...
      {
        additional: true,
        principles: [production, preservation, affordability, diversity, stability, fair],
        overview:
      ...
      {
        additional: true,
        principles: [engagement, production, affordability, location, complete],
      ...
      },
      {
        ...
        principles: [engagement, production, affordability, diversity, location, design, stability, fair],
        overview:
          'Requires municipalities to zone a sufficient amount of land to accommodate their "fair share" of affordable housing (based on state and regional job and population growth projections), and ensures that the land is appropriate for housing development. ',
        location: "California",
        resources: {
      ...
      },
      {
        ...
        principles: [engagement, production, affordability, diversity, location, design, stability, fair],
        overview:
          "Allows developers to override local zoning in communities that have less than 10% of their housing stock on the MA Subsidized Housing Inventory if the development project includes 20-25% affordable housing.",
        location: "Massachusetts",
        resources: {
          titles: "Chapter 40B",
      ...
      {
        additional: true,
        principles: [engagement, production, affordability, diversity, design, stability, fair],
      ...
      {
        additional: true,
        principles: [engagement, preservation, affordability, diversity, design, stability, fair],
        overview:
          "Used by municipalities to incentivize owners of existing unpermitted ADUs to obtain the building permits and inspections necessary to legalize the units.",
      ...
      {
        additional: true,
        principles: [engagement, production, affordability, location, design, stability, fair],
      ...
      {
        additional: true,
        principles: [engagement, production, affordability, diversity, location, complete, design, stability, fair],
        overview:
          "Used by municipalities to allow developers the flexibility to depart from existing zoning requirements in exchange for fulfilling specific goals for the site, such as providing a certain number of affordable units. ",
        location: "Nationwide",
        resources: {
  ...
  },
  {
    ...
    practices: [
      ...
      {
        considerations:
          "Municipalities with Good Landlord Programs should ensure they have the capacity to provide support to participating landlords. Educational campaigns may be needed to recruit landlord participants. Partnerships with qualified homeless service agencies may help refer qualifying households to the program.",
        ...
        who: "Local government",
        principles: [engagement, preservation, affordability, stability],
        adoption: "Local Action",
        location: "Austin, TX\nBoston, MA\nChicago, IL\nNew York, NY\nSan Francisco, CA",
        where:
      ...
      },
      {
        ...
        principles: [engagement, production, affordability, diversity, preservation],
        adoption: "Local Action",
        location: "Boston, MA\nBoulder, CO\nCambridge, MA\nNew York, NY\nSt. Paul-Minneapolis, MN",
        where:
          "Minneapolis-St. Paul, MN - Shared Capital Cooperative was founded in 1978 to facilitate bank financing for cooperatives. A cooperative itself, the organization now consists of 225 member cooperatives spread across 35 states. Shared Capital Cooperative raises funding from social investors and operates a self-help revolving loan fund to provide financing to housing and worker cooperatives. It is considered a Community Development Financial Institution that made 850 loans totaling $50 million to cooperatives across the country. ",
        resources: {
          titles:
            "Policy Link: Limited Equity Cooperatives\n\nNorthcountry Cooperative Development Fund: Housing Cooperatives \n\nNational Association of Housing Cooperatives",
          links:
      ...
      {
        considerations:
          "Like Community Land Trusts, land banks tend to work best where land values are low. They primarily operate in contexts with a supply of vacant, blighted properties ready for acquisition and where strong non-profit organizations and community development corporations are ready to take ownership. \n\nIn order to be successful, land banks must find consistent and dedicated funding sources.\n\nLand banks operating at the county or regional level require ongoing coordination with state and municipal entities.",
      ...
      {
        considerations:
          "Across the country, most existing rehabilitation/code compliance loan and grant programs for smaller properties are only available to homeowners, not landlords. Expanding these programs so that small or low-income landlords are also eligible would bring home improvements to a broader residential base. ",
      ...
      {
        additional: true,
        principles: [affordability, stability, fair],
      ...
      {
        additional: true,
        principles: [engagement, affordability, stability, fair],
        overview:
          "Used by municipalities to give affordable housing priority to residents (or their descendants) whose property was taken through eminent domain. ",
        location: "Boston, MA\nPortland, OR                ",
        resources: {
      ...
      },
      {
        ...
        principles: [engagement, production, preservation, affordability, diversity, location, complete, design, stability, fair],
        overview:
          "A movement led by local governments, community-based non-profit organizations, and academic and philanthropic institutions that encourages application of a racial equity lens to municipal policies and programs, including implementation and monitoring. ",
        location: "Nationwide",
        resources: {
      ...
      {
        additional: true,
        principles: [affordability, diversity, location, design, stability, fair],
        overview:
          "Federal vouchers that increase affordable housing choices for very low-income households by covering a portion of their rent in privately owned housing.",
        location: "Nationwide",
        resources: {
      ...
      },
      {
        ...
        principles: [affordability, diversity, location, design, stability, fair],
        overview:
          "State vouchers that increases affordable housing choices for very low-income households by covering a portion of their rent in privately owned housing.",
        location: "Massachusetts",
        resources: {
      ...
      {
        additional: true,
        principles: [engagement, affordability, location, design, stability, fair],
        overview:
          "Municipal program providing two years of rental assistance for families earning 40-80% of Denver\u2019s area median income. Funding for the rental subsidies comes from a combination of local public and private dollars, including local foundations and businesses. ",
        location: "Denver, CO",
        resources: {
      ...
      {
        additional: true,
        principles: [engagement, preservation, affordability, design],
        overview:
      ...
      },
      {
        ...
        principles: [engagement, affordability, stability, fair],
        overview:
          "Municipal office dedicated to the investigation of tenant harassment complaints, including those associated with construction in occupied buildings. ",
        location: "New York, NY    ",
        resources: {
      ...
      },
      {
        ...
        principles: [engagement, affordability, stability, fair],
        overview:
          "Municipal regulation that makes it unlawful for an owner, in connection with a buyout offer, to threaten a tenant, to contact a tenant at odd hours, or to provide false information to a tenant.",
        location: "New York, NY",
        resources: {
      ...
      },
      {
        ...
        principles: [engagement, affordability, stability, fair],
        overview:
          "Municipal program requiring developers to certify that they have not harassed existing tenants prior to seeking permits for renovating or demolishing rent-stabilized residential buildings.",
        location: "New York, NY",
        resources: {
          titles: "New York City CONH Program",
          links:
            "http://www1.nyc.gov/nyc-resources/service/1353/certification-of-no-harassment-or-exemption-application\n\nhttps://nextcity.org/daily/entry/nyc-tenants-right-advocates-score-another-victory",
        },
      ...
      {
        additional: true,
        principles: [engagement, production, preservation, affordability, design, stability, fair],
        overview:
          "Municipal zoning to ensure rental housing meets basic housing safety standards by requiring that all rental units be registered with the city and undergo proactive inspection for habitability. ",
        location: "Boston, MA\nChelsea, MA\nLos Angeles, CA      \nSeattle, WA",
        resources: {
      ...
      {
        additional: true,
        principles: [engagement, affordability, design, stability, fair],
        overview:
          "Municipality or state provides property tax abatements or exemptions for low-income homeowners, veterans, seniors, or other special classes of individuals.",
        location: "Nationwide",
        resources: {
      ...
      {
        additional: true,
        principles: [engagement, preservation, affordability, design, stability, fair],
      ...
      },
      {
        ...
        principles: [engagement, preservation, affordability, diversity, design, stability, fair],
        overview:
          "Municipal program encouraging the creation and preservation of housing that is affordable without government subsidy through a combination of financing and planning strategies, including acquisition assistance and special zoning district designation.",
      ...
      {
        additional: true,
        principles: [preservation, affordability, diversity, stability, fair],
        overview:
          "State law aimed at preserving existing privately-owned affordable housing by allowing the MA Department of Housing and Community Development (DHCD), or its designee, the right of first refusal to purchase housing with expiring affordability restrictions.",
        location: "Massachusetts",
        resources: {
          titles: "Chapter 40T",
      ...
      {
        additional: true,
        principles: [preservation, affordability, diversity, design, stability, fair],
        overview:
      ...
      },
      {
        ...
        principles: [engagement, production, location],
        overview:
          "Municipal strategy of applying a higher tax rate to land and a lower rate to structures on the land to stimulate development or improvements to existing structures, and to penalize speculative owners that leave lots unimproved.",
      ...
      },
      {
        ...
        principles: [engagement, production, affordability, diversity, design, stability, fair],
        overview:
          "Interest-free loans from the City to homeowners for developing ADUs, with payments deferred until the owner sells, transfers ownership, or refinances their home. ",
        location: "Boston, MA",
        resources: {
  ...
  },
  {
    ...
    practices: [
      ...
      {
        considerations:
          "Staff and boards of CDFIs should have financing and lending expertise. CDFIs dedicated to affordable housing development specifically must understand affordable housing production and preservation processes.",
      ...
      {
        considerations:
          "Research shows that TIF districts grow much faster than other areas that don't offer incentivizing tax exemptions. When using TIF, the chance of slower growth in other parts of the municipality must be considered.\n\nTIF funds set aside for affordable housing should have clear requirements of how they should be be used, including affordability limits, tenure types, and length of affordability.",
      ...
      },
      {
        ...
        principles: [production, affordability, location],
        overview:
          "Modeled after the federal program, this state program provides funding to developers for affordable rental housing development through tax credits. ",
        location: "Massachusetts",
        resources: {
      ...
      {
        additional: true,
        principles: [production, affordability],
      ...
      {
        additional: true,
        principles: [engagement, production, affordability, complete],
        overview:
          "Provides funding for capital projects to municipalities that have demonstrated a commitment to increasing housing supply in their communities.",
        location: "Massachusetts",
        resources: {
      ...
      },
      {
        ...
        principles: [engagement, production, affordability, location],
        overview:
          "Provides funding to municipalities that designate certain areas for additional housing development, at least 20% of which is reserved for low- or middle-income residents.",
        location: "California",
        resources: {
          titles: "SB 540 Text\n\nCalifornia Budget & Policy Center: 2017 Housing Legislative Package",
          links:
      ...
      {
        additional: true,
        principles: [engagement, production, preservation, affordability],
        overview:
          "Municipalities can levy a property tax whose proceeds are dedicated to producing and preserving affordable housing for low-income households.",
        location: "Seattle, WA",
        resources: {
      ...
      },
      {
        ...
        principles: [engagement, production, preservation, affordability],
        overview:
          "Enables local jurisdictions to levy a tax on residential construction, proceeds of which fund affordable housing production and downpayment assistance programs. ",
        location: "Oregon",
        resources: {
      ...
      },
      {
        ...
        principles: [engagement, production, affordability],
        overview:
          "The state assesses a recording fee on real estate transactions (excluding new home purchases), the proceeds of which fund affordable housing production. ",
        location: "California",
        resources: {
          titles: "SB 2 Text\n\nCalifornia Budget & Policy Center: 2017 Housing Legislative Package\n",
          links:
      ...
      },
      {
        ...
        principles: [engagement, production, affordability],
        overview:
          "Local government backs a loan or bond for an affordable housing project to make it more attractive for banks and investors, lowering interest rates.",
        location: "",
        resources: {
      ...
      {
        additional: true,
        principles: [production, preservation, affordability, diversity, design],
        overview:
          "Federal program that provides funding for a wide range of activities, including building, buying, and/or rehabilitating affordable housing for rent or homeownership.",
        location: "Nationwide",
        resources: {
      ...
      {
        additional: true,
        principles: [production, affordability, diversity],
      ...
      {
        additional: true,
        principles: [production, preservation, affordability, design],
        overview: "Provides communities with funds to build, preserve, and rehabilitate rental homes for low-income households.",
        location: "Massachusetts",
        resources: {
      ...
      {
        additional: true,
        principles: [engagement, production, preservation, affordability, diversity, design],
        ...
        resources: {
          ...
          links:
            "https://www.mhp.net/writable/resources/documents/municipal_affordable_housing_trust_guidebook.pdf\n\nhttps://www.policylink.org/sites/default/files/housing-trust-funds_0.pdf",
        },
      ...
      {
        additional: true,
        principles: [production, affordability, location, complete, design],
        overview:
          "Municipal, county, or regional fund supporting developers with acquisition and development of affordable housing within areas served by public transit. ",
      ...
      {
        additional: true,
        principles: [engagement, production, preservation, affordability, diversity, location, complete, design, stability],
        overview:
          "Adopted at the municipal level to fund affordable housing development and preservation activities (as well as open space and historic preservation activities) through a local property tax surcharge and state match. ",
        location: "Massachusetts",
        resources: {
      ...
      {
        additional: true,
        principles: [engagement, production, preservation, affordability, diversity, complete],
        overview:
          "Municipality can charge a one-time fee on new development to offset the impacts of that development on infrastructure and municipal services. ",
        location: "Nationwide",
        resources: {
      ...
      },
      {
        ...
        principles: [engagement, production, preservation, affordability, diversity, location, complete, design, stability, fair],
        overview:
          "Municipalities with less than 13% of their housing stock on the MA Subsidized Housing Inventory can apply for state funds to support new zoning, public infrastructure improvements, community development, and education for increased housing production.",
        location: "Massachusetts",
        resources: {
      ...
      },
      {
        ...
        principles: [engagement, production, location, complete],
        overview:
          "A private equity fund administered by the Conservation Law Foundation and Massachusetts Housing Investment Corporation supportive of housing projects that meet community, environmental, and health outcome criteria. ",
        location: "Massachusetts",
        resources: {
      ...
      },
      {
        ...
        principles: [engagement, production, preservation, affordability, diversity, location, complete, design, stability, fair],
        overview:
          "Performance-based financing to a public agency, non-profit organization, or foundation to accomplish a specific objective (e.g. homelessness mitigation, affordable housing production). The private and/or philanthropic lenders are repaid based on whether the program achieves its goals.",
        location: "Chicago, IL\nDenver, CO    \nHouston, TX    \nRichmond, CA\nMassachusetts",
        resources: {
      ...
      },
      {
        ...
        principles: [engagement, production, location],
        overview:
          "Reimbursement through the State for costs associated with increased school enrollment following adoption of a Chapter 40R Smart Growth Overlay District.",
        location: "Massachusetts",
        resources: {
          titles: "Chapter 40S",
  ...
  },
  {
    ...
    practices: [
      ...
      {
        considerations:
          "New construction techniques are almost certain to open up a can of worms (re: labor laws, building codes, zoning provisions, etc.). A good best practice may be supporting a pilot to assess the need for legislation or local regulatory revision.\n\nThe Massachusetts Board of Building Regulations and Standards and individual municipalities can update building codes to support 3D printed homes.",
    ...
    practices: [
      {
        ...
        overview:
          "Efforts to build broad coalitions between stakeholders, including local housing and community development organizations; financial, cultural, and educational institutions; local government; and local businesses.",
        location: "Nationwide",
        resources: {
      ...
      {
        additional: true,
        principles: [engagement, fair],
        overview:
          "Increases empathy for those enduring housing instability by sharing the experiences of those struggling to find safe, affordable, and stable housing.",
        location: "Detroit, MI\nPortland, OR\nSeattle, WA",
        resources: {
      ...
      },
      {
        ...
        principles: [engagement, stability],
        overview:
          "Municipalities, banks, and non-profit organizations help potential homeowners understand the financial options and obligations that come with homeownership.",
        location: "Nationwide",
        resources: {
