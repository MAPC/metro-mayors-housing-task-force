        ...
        <div className="container">
          <div className="best-practice-intro">
            ...
            <p>
              ...
              the Alliance for Housing Affordability, Mass Gov., and the U.S. Department of Housing
            ...
            <p>
              ...
              planning and zoning to funding resources to programming to construction techniques to
              community engagement and beyond. And yet this is by no means a comprehensive list; it
              should serve as a menu of housing strategies for communities to learn and choose from.
            </p>

            <p>
              No one strategy will solve the housing crisis, and not all strategies are appropriate for
              all places. But the right combination for the region and its diverse communities will help
              expand housing diversity and opportunity across the Commonwealth.
            </p>
          </div>
